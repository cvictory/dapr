...
func (c *daprClient) WatchState(ctx context.Context, in *GetStateRequest, opts ...grpc.CallOption) (Dapr_WatchStateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[0], "/dapr.proto.runtime.v1.Dapr/WatchState", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *daprClient) SubscribeEvent(ctx context.Context, opts ...grpc.CallOption) (Dapr_SubscribeEventClient, error) {
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[1], "/dapr.proto.runtime.v1.Dapr/SubscribeEvent", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedDaprServer) SubscribeEvent(Dapr_SubscribeEventServer) error {
